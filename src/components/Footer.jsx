  ...
  return (
    <div >
      ...
      <div className='flex flex-col gap-2'>
        <h3 className='text-nord4 font-semibold'>Início</h3>
      ...
      <div className='flex flex-col gap-2'>
        <h3 className='text-nord4 font-semibold'>Programação</h3>
        <div className='flex flex-col'>
      ...
      <div className='flex flex-col gap-2'>
        <h3 className='text-nord4 font-semibold'>Inscrição</h3>
        <div className='flex flex-col'>
        <a className='text-sm text-stone-500'>Sobre</a>
      ...
      <div className='flex flex-col gap-2'>
        <h3 className='text-nord4 font-semibold'>Submissão</h3>
        <div className='flex flex-col'>
      ...
      <div className='flex flex-col gap-2'>
        <h3 className='text-nord4 font-semibold '>Local</h3>
        <div className='flex flex-col'>

          ...
          <div className="flex flex-wrap lg:flex-nowrap gap-8 justify-center">
            <div className="flex gap-4 flex-col lg:max-w-[550px]">
              <p className="text-lg font-medium">
                ...
                de Atalaia. Os participantes do evento podem se hospedar também
                no Celi Hotel Aracaju&nbsp; (
                <a
                  href="https://www.celihotel.com.br"
                  target="_blank"
                  className="text-orange-500 text-underline"
                >
                  https://www.celihotel.com.br
                </a>
                ) ou no Ibis Budget Aracaju&nbsp; (
                <a
                  href="https://all.accor.com/hotel/8676/index.pt-br.shtml"
                  target="_blank"
                  className="text-orange-500 text-underline"
                >
                  https://all.accor.com/hotel/8676/index.pt-br.shtml
                </a>
                ), que ficam próximo ao local do evento.
              </p>
              <p className="text-lg font-medium">
                Hospedagens em ambos hotéis com TARIFAS ESPECIAIS para hóspedes
                que estão participando do evento, informar então no momento da
                reserva ou da hospedagem que estão participando do
                SIBRAGEC/SBTIC 2023. Contatos para reserva nos hotéis
                conveniados ao evento: 
                <br />
                Celi Hotel Aracaju:{" "}
                <a
                  href="mailto:eventos@celihotel.com.br"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-orange-500 text-underline"
                >
                  eventos@celihotel.com.br
                </a>
                <br />
                Ibis Budget Aracaju:{" "}
                <a
                  href="mailto:H8676-re@accor.com"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-orange-500 text-underline"
                >
                ...
                ou {" "}
                <a
                  href="mailto:Joseane.solom@accor.com"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-orange-500 text-underline"
                >
                  Joseane.solom@accor.com
                </a>
              </p>
